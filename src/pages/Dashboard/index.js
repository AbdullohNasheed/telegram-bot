  ...
  return (
    <body className="body">
      ...
      <div className="content">
        <Header />
        <Switch>
          <Route exact path={`/dashboard/user`} component={UsersPage} />
          <Route exact path={`/dashboard/dashboard`} component={DashboardPage} />
          <Route exact path={`/dashboard/katalogs`} component={KatalogsPage} />
          <Route exact path={`/dashboard/news`} component={NewsPage} />
          <Route exact path={`/dashboard/order`} component={OrderPage} />
